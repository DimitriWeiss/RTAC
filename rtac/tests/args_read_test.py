...
class TestArgsRead(unittest.TestCase):
    default = {'verbosity': 0, 'wrapper': 'No wrapper chosen!',
               ...
               'timeout': 300, 'contenders': 30, 'keeptop': 2, 'pws': False,
               'usedata': None, 'experimental': None, 'chance': 25,
               'mutate': 10, 'kill': 5, 'train_number': None,
               'train_rounds': 0, 'feature_gen': '', 'nc_pca_f': 3,
               'nc_pca_p': 5, 'jfm': 'polynomial', 'omega': 0.0001, 'gamma': 1,
               'alpha': 0.2, 'ac': ACMethod(1), 'paramlimit': 100000,
               'baselineperf': False, 'cpplt': 8,
               'log_folder': 'logs',
    ...
    scen_file = {'verbosity': 1, 'wrapper': 'wrapper.lacidac',
                 ...
                 'experimental': 'y', 'chance': 2, 'mutate': 100,
                 'kill': 50.0, 'train_number': 1.0, 'train_rounds': 0.0,
                 'feature_gen': 'feature_gen/lacidac_feats.py',
                 'nc_pca_f': 33, 'nc_pca_p': 55, 'jfm': 'linear',
                 'omega': 1e-06, 'gamma': 10.0, 'alpha': 0.02,
                 'ac': ACMethod(4), 'paramlimit': 1100000.0,
